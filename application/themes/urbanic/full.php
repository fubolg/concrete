...
$view->inc('elements/header.php', ['html' => $html]);
...
?>
        ...
        <div class="templatemo-grid" id="templatemo-grid">
            <?php
            $a = new Area('Grid');
            $a->display($c);
            ?>
        ...
        <div class="templatemo-image" id="templatemo-image">
            <?php
            $a = new Area('Image');
            $a->display($c);
            ?>
...
<?php $view->inc('elements/footer.php', ['html' => $html]); ?>
